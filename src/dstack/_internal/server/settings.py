...
SERVER_TEST_USERS_ENABLED = environ.get_bool("DSTACK_SERVER_TEST_USERS_ENABLED", default=False)

FEISHU_APP_ID = os.getenv("DSTACK_FEISHU_APP_ID") or None
FEISHU_APP_SECRET = os.getenv("DSTACK_FEISHU_APP_SECRET") or None
FEISHU_SCOPE = os.getenv("DSTACK_FEISHU_SCOPE", "")
...
PRELOAD_OFFERS_CATALOG_ENABLED = environ.get_bool(
    "DSTACK_SERVER_PRELOAD_OFFERS_CATALOG_ENABLED", default=False
)
